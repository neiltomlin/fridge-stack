...
import ScanReceiptAdminControls from '../_components/scanReceiptAdminControls';
        ...
        {reviewItems.length > 0 && (
          <div className="bg-slate-800 rounded-lg shadow-lg p-6 mb-8">
            ...
            <p className="mb-4 text-gray-300">
              Review and edit items before adding them to your fridge. You can toggle between food
              and non-food items, adjust the category, quantity, and estimated days until expiry.
            </p>
